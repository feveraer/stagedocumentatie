...
do
  ...
  echo "select count(*) from ${tb} where and ${TIME_COLUMN} > '2015-01-01 00:00:00' and ${TIME_COLUMN} < '2015-04-01 00:00:00'" >> /home/twitter/query_results/${DATABASE_NAME}_Qs.txt
  ...
  echo "select count(*) from ${tb} where and ${TIME_COLUMN} > '2015-04-01 00:00:00' and ${TIME_COLUMN} < '2015-07-01 00:00:00'" >> /home/twitter/query_results/${DATABASE_NAME}_Qs.txt
  ...
  echo "select count(*) from ${tb} where and ${TIME_COLUMN} > '2015-07-01 00:00:00' and ${TIME_COLUMN} < '2015-10-01 00:00:00'" >> /home/twitter/query_results/${DATABASE_NAME}_Qs.txt
