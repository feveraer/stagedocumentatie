...
class DateTimeTest extends AssertionsForJUnit {
  @Test def testSecondsDifference(): Unit = {
    ...
    val solution1 = new DateTimeDifference(0, 0, 0, 0, 0, 10)
  ...
  @Test def testMinutesDifference(): Unit = {
    ...
    val solution1 = new DateTimeDifference(0, 0, 0, 0, 10, 0)
  ...
  @Test def testHourDifference(): Unit = {
    ...
    val solution1 = new DateTimeDifference(0, 0, 0, 2, 0, 0)
  ...
  @Test def testDayDifference(): Unit = {
    ...
    val solution1 = new DateTimeDifference(0, 0, 2, 0, 0, 0)
  ...
  @Test def testMonthDifference(): Unit = {
    val time1 = new DateTime(2015, 10, 1, 0, 0, 0)
    val time2 = new DateTime(2015, 12, 1, 0, 0, 0)
    val time3 = new DateTime(2015, 8, 1, 0, 0, 0)

    val time4 = new DateTime(2015, 12, 1, 0, 0, 0)
    val time5 = new DateTime(2016, 2, 1, 0, 0, 0)

    val solution1 = new DateTimeDifference(0, 2, 0, 0, 0, 0)
  ...
  @Test def testYearDifference(): Unit = {
    ...
    val time3 = new DateTime(2014, 10, 1, 0, 0, 0)

    val solution1 = new DateTimeDifference(1, 0, 0, 0, 0, 0)
  ...
  @Test def testRandomDifference(): Unit = {
    ...
    val solution1 = new DateTimeDifference(1, 0, 1, 10, 12, 50)
    ...
    val solution2 = new DateTimeDifference(0, 11, 30, 13, 47, 10)
    ...
    val solution3 = new DateTimeDifference(0,0,2,7,32,0)
  ...
  @Test def testLeapYear(): Unit = {
    var isLeap = DateTime.IS_LEAP_YEAR(2016)
    assertTrue(isLeap)

    isLeap = DateTime.IS_LEAP_YEAR(2015)
    assertFalse(isLeap)

    isLeap = DateTime.IS_LEAP_YEAR(1900)
    assertFalse(isLeap)
  }
