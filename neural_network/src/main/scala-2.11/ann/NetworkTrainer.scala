...
import org.encog.ml.data.versatile.sources.{CSVDataSource, VersatileDataSource}
...
class NetworkTrainer(val pathToTrainingsData: String) {
  ...
  def train {
    ...
    val columnDayDiff: ColumnDefinition = data.defineSourceColumn("DayDiff", ColumnType.continuous)
    val columnHourDiff: ColumnDefinition = data.defineSourceColumn("HourDiff", ColumnType.continuous)
    val columnMinuteDiff: ColumnDefinition = data.defineSourceColumn("MinuteDiff", ColumnType.continuous)
    val columnSecondDiff: ColumnDefinition = data.defineSourceColumn("SecondDiff", ColumnType.continuous)
