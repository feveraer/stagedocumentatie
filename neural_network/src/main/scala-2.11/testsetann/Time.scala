...
object Time {
  ...
  private val DAYS_IN_MONTH_NORMAL_YEAR = (31,28,31,30,31,30,31,31,30,31,30,31)
  private val DAYS_IN_MONTH_LEAP_YEAR = (31,29,31,30,31,30,31,31,30,31,30,31)

  def DAYS_IN_MONTH(year: Int, month: Int): Unit ={
